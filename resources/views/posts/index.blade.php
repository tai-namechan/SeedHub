<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="index-html">
    ...
    <main class="index-method">
        ...
        <div class="meetings" id="app">
            ...
            <div class="index-memox">
                ...
                <!-- いいね -->
                <like-component :meeting-id="{{ json_encode($meeting->id) }}" :user-id="{{ json_encode($userAuth->id)  }}" :default-Liked="{{ json_encode($defaultLiked) }}" :default-Count="{{ json_encode($meeting->likes_count) }}"></like-component>
